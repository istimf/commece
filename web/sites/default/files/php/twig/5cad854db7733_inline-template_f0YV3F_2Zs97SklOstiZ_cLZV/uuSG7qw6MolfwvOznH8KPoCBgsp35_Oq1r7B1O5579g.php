...
/* {# inline_template_start #}<a href="/products/special/{{ name|lower|replace({'&amp;-':''}) }}-{{ tid }}">{{ name_1 }}</a> */
class __TwigTemplate_77d7363abce52530e8fb434ce8c5ea6544ad32b0e30d967f344257bbc029ee63 extends \Twig\Template
{
    ...
    {
        return "{# inline_template_start #}<a href=\"/products/special/{{ name|lower|replace({'&amp;-':''}) }}-{{ tid }}\">{{ name_1 }}</a>";
    }
    ...
    {
        return new Source("", "{# inline_template_start #}<a href=\"/products/special/{{ name|lower|replace({'&amp;-':''}) }}-{{ tid }}\">{{ name_1 }}</a>", "");
    }
}
